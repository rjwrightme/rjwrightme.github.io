...
const PhotoshopIcon: React.FC<PhotoshopIconProps> = ({ size }) => {
  return (
    <svg
	...
	V56.2C0,25.2,25.2,0,56.2,0z"
      ...
      <g id="Ps">
        <path
          id="s"
          fill="#57A6F8"
          d="M188.1,107.7c-2.9-1.5-5.9-2.6-9.2-3.2c-3.5-0.8-7.1-1.2-10.7-1.2c-1.9-0.1-3.9,0.2-5.7,0.7
        ...
        <path
          id="P"
          fill="#57A6F8"
          d="M56.4,162.3V64.1c0-0.7,0.3-1,1-1c1.6,0,3.1,0,5.3-0.1c2.3-0.1,4.7-0.1,7.3-0.2
