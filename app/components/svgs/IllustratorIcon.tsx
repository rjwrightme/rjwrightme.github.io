interface IllustratorIconProps {
  size: number;
}

const IllustratorIcon: React.FC<IllustratorIconProps> = ({ size }) => {
  return (
    <svg
	...
	V56.2C0,25.2,25.2,0,56.2,0z"
      ...
      <path
        fill="#FF9A00"
        d="M117.1,139.3H80.6l-7.4,23c-0.2,0.9-1,1.5-1.9,1.4H52.9c-1.1,0-1.4-0.6-1.1-1.8l31.5-90.7c0.3-1,0.6-2.1,1-3.2
